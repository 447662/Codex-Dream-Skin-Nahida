...
The `assets/forest-spirit-*` image pack is assembled from user-supplied character
art and element references. It is not granted under the MIT software license;
redistribution requires permission from the original rights holders. The
software continues to support the MIT-covered abstract asset and user-provided
single-image themes.
